...
#' included within an R6 object as a named list of libraries and tools. This
...
#' 
#' @examples
#' # Initialize SAGA-GIS as a R6 object if SAGA-GIS is installed
#' # in a recognized location
#' 
#' library(Rsagacmd)
...
#'         TARGET_OUT_GRID = tempfile(pattern = 'terrain', fileext = '.sgrd'))
#'    
