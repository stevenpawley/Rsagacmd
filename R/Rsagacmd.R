...
#' version has been tested using SAGA-GIS versions 2.3.1 to 7.0.0 on Windows
...
#' functions are generated by the \code{\link{saga_gis}} function and are
...
#' similar way to the raster package, using the saga_remove_tmpfiles function.
#'
#' @section Notes:
